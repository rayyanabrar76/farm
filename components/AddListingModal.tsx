        ...
        <div className="p-6 grid grid-cols-2 gap-4">
          <div className="col-span-2">
            ...
            <input name="name" value={form.name} onChange={handleChange}
              className="w-full border-2 border-gray-200 focus:border-primary-500 rounded-xl px-4 py-2.5 text-sm outline-none transition-colors"
          ...
          <div>
            ...
            <select name="category" value={form.category} onChange={handleChange}
              className="w-full border-2 border-gray-200 focus:border-primary-500 rounded-xl px-4 py-2.5 text-sm outline-none bg-white transition-colors"
            >
          ...
          <div className="col-span-2">
            ...
            <div
              ...
              className="border-2 border-dashed border-gray-200 hover:border-primary-400 hover:bg-primary-50 rounded-xl p-6 text-center cursor-pointer transition-colors group"
            >
