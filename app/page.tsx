    ...
    <>
      ...
      <section className="py-24 px-4 bg-gray-50 border-t border-gray-100">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-2xl sm:text-3xl md:text-4xl font-black text-gray-900 mb-6 leading-snug">
            Agrolync was built by Nigerians,<br />for Nigerian farmers.
          </p>
          <p className="text-gray-500 text-lg mb-14 leading-relaxed max-w-xl mx-auto">
      ...
      {/* ── GET THE APP ── */}
      <section className="py-20 px-4 bg-surface border-t border-gray-100">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-10">
          <div>
            ...
            <h3 className="text-3xl sm:text-4xl font-black text-gray-900 mb-2">Agrolync in your pocket.</h3>
            <p className="text-gray-500 text-base">Works on basic Android phones and 2G networks. Zero data? Use <span className="font-bold text-primary-600">*347#</span></p>
          </div>
          <div className="flex gap-3 shrink-0">
            <a href="#" className="flex items-center gap-2.5 bg-gray-900 hover:bg-gray-800 text-white px-5 py-3 rounded-2xl transition-colors">
      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          <h2 className="text-4xl font-black text-white mb-2">Farmers &amp; Buyers Love Agrolync</h2>
          <p className="text-white/40 text-lg mb-14 max-w-xl">Real stories from real people transforming African agriculture.</p>
      ...
      >
        ...
        <div className="max-w-3xl mx-auto text-center relative">
          ...
          <h2 className="text-4xl sm:text-5xl font-black text-white mb-4 tracking-tight leading-tight">Ready to Transform<br />Your Farm Business?</h2>
          <p className="text-white/58 text-lg mb-10 leading-relaxed max-w-xl mx-auto">
